...
Columbia\quad \textsuperscript{2}\,Computational Biodiversity Science
and Services\quad \textsuperscript{3}\,School of Natural and
Environmental Sciences, Newcastle
University\quad \textsuperscript{4}\,Université de
Montréal\quad \textsuperscript{5}\,Université de
Sherbrooke\quad \textsuperscript{6}\,Quebec Centre for Biodiversity
Science
...
Serengeti food web of mammals and plants as our case study, and provide
updated range maps for all predators by taking into account food-web
...
datasets (Hurlbert and Jetz 2007; Hurlbert and White 2005;
\textbf{Ficetola2014EvaRoba?}), none have used different types of
information so far (i.e., ecological characteristics other than
geographical distribution). Here we suggest jointly analysing species
...
2005; \textbf{Ficetola2014EvaRoba?}). Adding ecological interaction data
to this comparison might help to elucidate where these (dis)agreements
are more likely to be true and which dataset better represent the actual
...
available at {[}\textbf{link to Zenodo archive}{]}.
...
12.3\%). \textless!---\textgreater Note to self: here I calculated how
much the difference represents as a proportion of the total proportion,
which means the decreased rate. E.g., when the range\_prop\_diff is
equal to the original proportion (range\_prop), this means that this
species lost 100\% of the original proportion. Therefore I can't use
range\_prop\_diff numbers if I'm talking about \%
lost.\textless---\textgreater{} On the other hand, three species,
...
57.4\%, and 100\% respectively. These last two species are also the only
...
such a conspicuous mismatch between both the original and updated IUCN
range maps, and between GBIF and IUCN data, may indicate a taxonomic
...
Natural Sciences and Engineering Research Council (NSERC) and the Fond
de recherche du Québec - Nature et technologie (FRQNT) doctoral
scholarships; TP is funded by the Canadian Institute of Ecology \&
Evolution; FW is funded by the Royal Society (Grant number:
CHL\textbackslash R1\textbackslash180156). We thank the editor and
reviewer for their thoughtful comments, which considerably improved this
manuscript.
...
\leavevmode\hypertarget{ref-Dansereau2021SimJl}{}%
---------. 2021. {``SimpleSDMLayers.jl and GBIF.jl: A Framework for
Species Distribution Modeling in Julia.''} \emph{Journal of Open Source
Software} 6 (57): 2872. \url{https://doi.org/10.21105/joss.02872}.
...
\emph{bioRxiv}, February, 2020.02.21.960161.
...
\leavevmode\hypertarget{ref-Gotelli2010MacSig}{}%
---------. 2010. {``Macroecological Signals of Species Interactions in
the Danish Avifauna.''} \emph{Proceedings of the National Academy of
Sciences} 107 (11): 5030--35.
\url{https://doi.org/10.1073/pnas.0914089107}.
...
\leavevmode\hypertarget{ref-Rondinini2006TraDif}{}%
---------. 2006. {``Tradeoffs of Different Types of Species Occurrence
Data for Use in Systematic Conservation Planning.''} \emph{Ecology
Letters} 9 (10): 1136--45.
\url{https://doi.org/10.1111/j.1461-0248.2006.00970.x}.
...
\emph{Biodiversity Data Journal} 8 (September): e53474.
...
\emph{Frontiers in Plant Science} 9 (February): 127.
...
\leavevmode\hypertarget{ref-Valiente-Banuet2015SpeLosa}{}%
...
\leavevmode\hypertarget{ref-Windsor2022UsiEco}{}%
---------. 2022. {``Using Ecological Networks to Answer Questions in
Global Biogeography and Ecology.''} \emph{Journal of Biogeography} n/a
(n/a). \url{https://doi.org/10.1111/jbi.14447}.
