...
Ecological networks represent species as nodes and interactions between species as links, which allow quantifying the structure of animal-plant relationships, and recognize species with higher degree values as better connected, and with a more important role in modularity (Acevedo‐Quintero et al., 2020). The connection between species can be given by antagonistic and mutualistic interactions, which leads to the formation of complex networks that shape ecological structures and maintain the essential functions of ecosystems. These functions include seed dispersal, pollination, biological control, among others. (Albrecht et al., 2018) Studies reported that changes in predator density and diversity along plant diversity gradients, and modifications in consumer communities can be a mechanistic cause of changes in predation rates (Moreira et al., 2015) (Thakur & Eisenhauer, 2015) As occur whether interactions between predator species are, synergistic, antagonistic, or complementary, predation may increase or decrease (Hertzog et al., 2017).
For herbivore populations, the effects of plant diversity on population stability depended on the degree of herbivore feeding specialization, as plant diversity increased herbivore stability at the community level. (Haddad et al., 2011). Given that plant-herbivore networks are spatiotemporally dynamics, and can be affected by several factors like seasonality, disturbance, and specific attributes of species. (Dáttilo & Rico-Gray, 2018).
Thus, complement the study of networks with geographical information will lead us to obtain more accurate information not only on how species interact, but also how the dynamics of these networks can change from spatial factors, additional to highlight the importance of understanding plant-herbivore patterns in ecological networks.

Herbivore diet amplitude is a key functional trait underlying the trophic effects of carnivores on both herbivores and plants. But also, makes it difficult to build a network based on plant species with herbivorous. Therefore, to understand the evolution of ecological interactions it is crucial to investigate how the outcome of the interaction species traits vary geographically and seasonally. (Forister et al., 2015; Mooney et al., 2010; Singer et al., 2014; Verçosa et al., 2019)
